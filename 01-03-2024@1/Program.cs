...
class Program
{
    ...
    private static void ExibirStatusAtual(double distanciaPercorrida, double segundo, double tempoRestante, double velocidadeInstantanea, double distanciaPercorridaInstantanea)
    {
    ...
    private static void CalcularStatusFinal(double gravidade, double alturaQueda, out double tempoQueda, out double velocidadeImpacto, out double distanciaPercorrida)
    {
    ...
    private static void CalcularStatusAtual(double gravidade, double tempoQueda, double segundo, out double tempoRestante, out double velocidadeInstantanea, out double distanciaPercorridaInstantanea)
    {
